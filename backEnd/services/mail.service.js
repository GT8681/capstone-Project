  ...
  const mailOptions = {
    ...
    <div style="padding: 30px; background-color: #ffffff;">
      ...
      <div style="text-align: center; margin: 30px 0;">
        <a href="https://capstone-project-f7sq.vercel.app/" style="background-color: #28a745; color: white; padding: 15px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;">Accedi alla tua Dashboard</a>
      </div>
